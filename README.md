...
```
wget -N https://raw.githubusercontents.com/beastW1/XrayR-script/master/install.sh && bash install.sh
```
...
2. `git clone https://github.com/beastW1/XrayR-script XrayR-release`
3. `cd XrayR-release`
4. 编辑config。
